...
<head>
    ...
    <title>Carreleur à <?php echo $ville;?> (<?php echo $codePostal; ?>)</title>
    ...
    <section class="breadcrumbs">
        <div class="container">
            ...
            <ol>
                ...
                <li>Carreleur à <?php echo $ville;?></li>
            </ol>
            <h1>Carreleur à <?php echo $ville;?>: Pose & Fourniture de Carrelage</h1>
